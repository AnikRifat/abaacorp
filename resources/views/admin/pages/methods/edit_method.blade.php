        ...
        <form action="{{ route('method.update', $method->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" id="summernote4" name="description" rows="3" placeholder="Enter ...">{{ $method->description }}</textarea>
                </div>
                <div class="form-group">
                    <label for="color">color</label>
                    <input type="text" class="form-control" name="color" value="{{ $method->color }}" id="color">
                </div>
                <div class="form-group">
